...
/* harmony import */ var _login_login__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(8);
/* harmony import */ var _login_login__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_login_login__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _apiCalls__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(6);
/* harmony import */ var _model__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(7);
...
function initApp() {
  Promise.all([
    (0,_apiCalls__WEBPACK_IMPORTED_MODULE_2__.getAPIData)(store.getAPIKey('travelers')),
    (0,_apiCalls__WEBPACK_IMPORTED_MODULE_2__.getAPIData)(store.getAPIKey('trips')),
    (0,_apiCalls__WEBPACK_IMPORTED_MODULE_2__.getAPIData)(store.getAPIKey('destinations')),
  ])
    .then(values => {
      ...
      store.setKey('currentUser', (0,_model__WEBPACK_IMPORTED_MODULE_3__.getRandomTraveler)(store.getKey('travelers')));
    })
    .then(() => {
